...
путем смешения других цветов. При смешивании двух основных цветов получается вторичный
цвет:
...
if (not (col1 == 'красный' or col1 == 'синий' or col1 == 'желтый')) or (
not (col2 == 'красный' or col2 == 'синий' or col2 == 'желтый')):
    print('ошибка цвета')
else:
    if col1 == col2:
        print(col1)
    elif (col1 == 'красный' and col2 == 'синий') or (
            col2 == 'красный' and col1 == 'синий'):
        print('фиолетовый')
    elif (col1 == 'красный' and col2 == 'желтый') or (
            col2 == 'красный' and col1 == 'желтый'):
        print("оранжевый")
